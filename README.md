...
License](https://github.com/elastic/elasticsearch/blob/6.7/licenses/ELASTIC-LICENSE.txt),
and includes the full set of [free
features](https://www.elastic.co/subscriptions).

View the detailed release notes
[here](https://www.elastic.co/guide/en/elasticsearch/reference/6.7/es-release-notes.html).
